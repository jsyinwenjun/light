...
public class InputMessage implements Serializable {  
    ...
    private Map<String,String> ScanCodeInfo;
	...
	public Map<String, String> getScanCodeInfo() {
		return ScanCodeInfo;
	}

	public void setScanCodeInfo(Map<String, String> scanCodeInfo) {
